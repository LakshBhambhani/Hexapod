...
package com.laksh.hexapod;

import com.laksh.hexapod.commands.HomeAll;
import com.laksh.hexapod.commands.ReverseTest;
import com.laksh.hexapod.commands.ServoTest;
import com.laksh.hexapod.commands.TripodGait;
import com.laksh.hexapod.commands.WaveGait;
...
//  private Command autonomousCommand, operatorControl;
  ...
  public void robotInit() {
    ...
    Logger.consoleLog("Robot init");
    System.out.println("Robot init");

    // The command we want to test goes here
    Scheduler.getInstance().add(new HomeAll());
//    Scheduler.getInstance().add(new ServoTest(Robot.body.getHips()));
//    Scheduler.getInstance().add(new WaveGait(10));
  }
